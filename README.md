...
Application: Most of PR systems are based on this approach. Features are assumed generated by a state of nature or class-conditioned set of probabilities and/or probability density functions.

**Syntactic PR**: the _underlying structure of the pattern_ provides the information fundamental for PR.

Application: It formulate hierarchical descriptions of complex patterns built up from simpler sub-patterns.
